...
import com.antareza.tesdanamon.util.dp2px
...
class SplashView @JvmOverloads constructor(
    ...
    private val backgroundColor = context.getColor(R.color.white)
    ...
    private var logoWidthHeight: Float = 0.0f
    private var viewportWidthHeight: Float = 0.0f
    ...
    init {
        ...
        VectorDrawableParser.parsedVectorDrawable(resources, R.drawable.ic_splash).run {
